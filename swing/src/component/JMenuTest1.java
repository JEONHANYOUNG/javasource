...
public class JMenuTest1 extends JFrame {
	...
	public JMenuTest1() {
		...
		load.addActionListener(new MenuActionListend());
		screenMenu.add(load);
		
		JMenuItem hide = new JMenuItem("Hide");
		hide.addActionListener(new MenuActionListend());
		screenMenu.add(hide);
		
		JMenuItem reshow = new JMenuItem("ReShow");
		reshow.addActionListener(new MenuActionListend());
		...
		exit.addActionListener(new MenuActionListend());
		screenMenu.add(exit);
		...
		imgLabel = new JLabel();
		add(imgLabel,BorderLayout.CENTER); // contentPane 안에서 상속 받는 것이므로 add를 나중에 넣어야함
		
	}

		private class MenuActionListend implements ActionListener{
