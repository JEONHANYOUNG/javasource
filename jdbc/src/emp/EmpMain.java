	...
	public static void main(String[] args) {
		...
		while (run) {
			...
			case 3: 
				...
				list = dao.orderBySal();
				for(EmpDTO dto2:list) { // 향상된 for 문
			...
			case 5:
				...
				break;
			case 6:
				System.out.println("\n*** 신입사원 입력  *** "); // 위에서 선언한 것은 선언 안한거고 위에 선언 하지 않은 것은 선언한 경우
				
//				System.out.print("사원번호 : ");  1) 방법 
//				empno =sc.nextInt();
...
//				newDto.setDeptno(deptno);
				...
				EmpDTO newDto = new EmpDTO(); // 2) 방법  이 방법도 가능하다
